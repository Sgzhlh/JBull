...
def validPrice(dir_name):
    # 判断str 是否有Long
    long_tip = 'Long'
    if re.search(long_tip.upper(), dir_name.upper()):
        cuxiao_price = 44.99
        normal_price = 94.99
    else:
        cuxiao_price = 39.99
...
for single_dir in os.listdir(source_dir_name):
    ...
    # 根据图片数量获取url连接
    img_url = [
        'https://raw.githubusercontent.com/Sgzhlh/JBull/master/Football/Popular Club/AC Milan/AC Milan F.C Ronaldinho 2009_2010 Home Retro Premium Jersey/0{}.jpg'.format(
